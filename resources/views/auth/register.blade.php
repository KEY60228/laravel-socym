<html>
  ...
  <body>
    ...
    <form name="registform" action="/auth/register" method="post">
      ...
      パスワード: <input tyep="password" name="password" size="30"><span>{{ $errors->first('password') }}</span><br>
      パスワード(確認): <input type="password" name="password_confirmation" size="30"><span>{{ $errors->first('password-_confirmation') }}</span><br>
